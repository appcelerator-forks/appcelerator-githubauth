...
before(function (next) {
    ...
    var files = path.join(process.cwd(), 'tests');
    server.loadRoute(files + '/routes/fooMe.js');
    server.loadRoute(files + '/routes/youFoo.js');
...
function getConfiguration() {
    var files = path.join(process.cwd(), 'tests/conf');
